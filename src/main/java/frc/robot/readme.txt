...
3/7/2026
SO MANY CHANGES
-Robot was not shooting correctly so we decided to take the command classes and turn them into txt files
-- Those comand files were consolidated and added into the FuelSubsystem.java 
--We pulled a bunch of the edits from https://github.com/alex-montesinos/2026_SwerveKitbot/tree/main/src/main/java/frc/robot
